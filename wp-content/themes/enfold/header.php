<?php
	...
	global $avia_config;
        $lightbox_active = avia_get_option( 'lightbox_active' );
	
	$avia_config['use_standard_lightbox'] = empty( $lightbox_active ) || ( 'lightbox_active' == avia_get_option( 'lightbox_active' ) ) ? 'lightbox_active' : 'disabled';
	/**
...
wp_head();
?>
    <script type="text/javascript" src="/wp-content/themes/enfold/js/custom.js?ver=1.12"></script>
